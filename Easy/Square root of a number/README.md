<h2><a href="https://www.geeksforgeeks.org/problems/square-root/1?page=2&sprint=0ec03cea5d45f27194a614ac5db94f0c&sortBy=submissions">Square root of a number</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer <strong>x,</strong>&nbsp;find the square root of x. If <strong>x</strong> is not a perfect square, then return floor(√x).</span></p>
