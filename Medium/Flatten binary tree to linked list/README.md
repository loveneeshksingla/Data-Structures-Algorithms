<h2><a href="https://www.geeksforgeeks.org/problems/flatten-binary-tree-to-linked-list/1?page=1&sprint=0ec03cea5d45f27194a614ac5db94f0c&sortBy=submissions">Flatten binary tree to linked list</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given the root of a binary tree, flatten the tree into a "lLinked list":</span></p>
<ul>
