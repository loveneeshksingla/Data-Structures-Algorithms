<h2><a href="https://www.geeksforgeeks.org/problems/subarrays-with-sum-k/1?page=1&sprint=0ec03cea5d45f27194a614ac5db94f0c&sortBy=submissions">Subarrays with sum K</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an unsorted array of integers, find the number of continuous subarrays having sum exactly equal to a given number k.</span></p>
