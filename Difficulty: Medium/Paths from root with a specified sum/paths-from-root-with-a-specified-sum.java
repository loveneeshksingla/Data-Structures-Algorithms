...
class Solution
{
    ...
    public static void solve(Node root, int sum, int curSum, ArrayList<Integer> curList) {
        ...
        solve(root.left, sum, curSum+root.data, curList);
        solve(root.right, sum, curSum+root.data, curList);
