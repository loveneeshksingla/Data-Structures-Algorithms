...
class Solution {
    ...
    static TreeMap<Integer, ArrayList<Integer>> map = null;
    ...
    static void verticalOrderTra(Node root, int level) {
        ...
        verticalOrderTra(root.left, level-1);
        verticalOrderTra(root.right, level+1);
